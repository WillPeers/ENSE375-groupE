...
public class PatientHistogramTest
{
	...
	/*
	 * null_count_check checks for empty array
	 * should return 0
	 */
	@Test
	...
	/*
	 * should_Add_True checks for valid input  
	 * Should return true
	 */
    @Test
    ...
    /*
     * Check for out of boundary cases:
     * I will try to add the value on 20:Vertical index and 10:Horizontal index
     * Should return false
     */
    @Test
	...
	/*
	 * valid_count_True checks for valid patient count in that region
	 * should return 1
	 */
	@Test
	...
	/*
	 * Invalid_check_False checks Invalid or out of boundary exception
	...
	/*
	 * delete_True checks for 1 in the array
	 * if patient exists, it will remove the patient
	 * should return true
	 */
	@Test
	...
	/*
	 * delete_false checks for 1 in the array
	 * No patient exists
	 * should return false
	 */
	@Test
	...
	/*
	 * delete_True checks out of boundary arbitrary values
	 * throws exception
	 * should return false
	 */
	@Test
